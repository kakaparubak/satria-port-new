...
const AboutMe = (props: ScriptProps) => {
  return (
    <div id={props.id} className="relative w-screen h-[100svh] lg:h-[70svh] bg-gradient-to-b from-gray-900 from-50% to-black flex flex-col lg:flex-row justify-center items-center gap-16 lg:gap-25 text-gray-100">
      ...
      <div className="w-[80%] lg:w-3/10" data-speed="1.06">
        <h2 className="font-montserrat text-4xl md:text-5xl lg:text-5xl font-bold w-fit">
          Hello!
        </h2>
        <h3 className="mt-2 font-montserrat text-2xl md:text-3xl lg:text-3xl font-medium w-fit">
          I&apos;m{" "}
          <span className="font-semibold underline decoration-indigo-300 text-white">
            {aboutMe.name}
          </span>
        </h3>
