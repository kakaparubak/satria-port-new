...
const AboutMe = () => {
    return (
        <div className="relative w-screen h-[100svh] lg:h-[70svh] bg-gradient-to-b from-gray-950 to-black flex flex-col lg:flex-row justify-center items-center gap-16 lg:gap-25 text-gray-100">
